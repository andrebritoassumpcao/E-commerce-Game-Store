    ...
    <Router>
      ...
      <Container customClass="min-height">
        <Routes>
          ...
          <Route path="/todos/game/:id" element={<Game />} />
          <Route path="/acao/game/:id" element={<Game />} />
          <Route path="/aventura/game/:id" element={<Game />} />
          <Route path="/esportes/game/:id" element={<Game />} />
          <Route path="/estrategia/game/:id" element={<Game />} />
          <Route path="/ofertas/game/:id" element={<Game />} />
        </Routes>
      </Container>
      <Footer />
    </Router>
